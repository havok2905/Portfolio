...
<div>
	...
	<h3>Coursework</h3>
	<h4 class="resume">Web Design Workshop</h4>
	<ul class="markedlist">
		<li>Title: Front-End Exchange</li>
		<li>Role: Lead Developer/Project Manager</li>
		<li>Technologies: HTML, CSS, JavaScript, PHP, Dr. Moshell's API</li>
	</ul>
	<p>
		<strong>Responsibilites:</strong> As a team, develop and test a responsive and mobile banking application using a provided 
	...
	<h3>Employment</h3>
	<h4 class="resume">University of Central Florida (May 2012 - Present)<br/> Center For Distributed Learning, Orlando Florida</h4>
	<h5>Techranger</h5>
	<p>
	...
	<p>
		<strong>Learn Programming with Robots:</strong> Building an HTML5 based try JavaScript application that teaches through manipulating digital robots through
	...
	<h4 class="resume">Kittatinny Mountain Scout Reservation (June 2006 - August 2007)<br/> Central NJ Council: Boyscouts of America, Dayton NJ</h4>
	<h5>Camp Counselor in Training</h5>
	<p>
	...
	<h5>Camp Counselor and Instructor</h5>
	<p>
	...
	<h3>Languages, Frameworks, &amp; Software</h3>
	<ul class="markedlist">
